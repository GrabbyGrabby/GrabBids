...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex min-h-screen bg-[#0A0A0A] text-white selection:bg-blue-500/30">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-[#121212] border border-white/10 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all"
                required
              />
            </div>
                  ...
                  <button
                    ...
                    className={`px-3 py-2.5 rounded-lg text-sm transition-all border ${
                      selectedSize === size
                        ...
                        : "bg-[#121212] border-white/5 text-gray-400 hover:border-white/20 hover:text-gray-300"
                    }`}
                  >
                    {size}
                  </button>
      ...
      {/* Right Panel - Visual */}
      <div className="hidden lg:flex w-[55%] relative overflow-hidden bg-[#0a0a0a]">
